...
<h1 class="ml-5">Form Edit Data Rumah Makan</h1>
<div class="col-lg-5 ml-5">
    <form action=" /Rms/{{ $rumahmakan->id }} " method="post"  enctype="multipart/form-data"> 
        @csrf
        @method('PUT')   
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_rm" value="{{ old('nama_rm') ? old('nama_rm') : $rumahmakan->nama_rm }}">
                @error('nama_rm')
                 <div class="alert alert-danger">{{ $message }}</div>   
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <select name="jam_buka" class="form-select">
                    <option>{{ old('jam_buka') ? old('jam_buka') : $rumahmakan->jam_buka }}</option>
            ...
            <div class="form-group ">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="formFile" name="image" value="{{ old('image') ? old('image') : $rumahmakan->image }}"
                    >
                </div>
       ...
       <a href="/Rms" class="btn btn-primary">Back</a>
    </form>
</div>
@endsection